...
public void setup() {
  ...
  sample = new SoundFile(this, "Sexy_Sushi.mp3");
  sample.loop();
...
public void draw() {
  ...
  float frequenceMedium = sum[2];
  float frequenceAigu = sum[2];
  ...
  ellipse(520, height / 2, frequenceAigu * 1500, frequenceAigu * 1500);
}