...
public void draw() {
  ...
  float frequenceBasse = sum[1];
  float frequenceMedium = sum[5];
  float frequenceAigu = sum[3];

  ellipse(width /2, height / 2, frequenceBasse * 1500, frequenceBasse * 1500);
  ellipse(100, height / 2, frequenceMedium * 1500, frequenceMedium * 1500);
